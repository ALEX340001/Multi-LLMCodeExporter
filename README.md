...
1. Заголовок с метаданными (режим, дата, количество файлов, оценка токенов).
2. Рекомендации по LLM в зависимости от размера.
3. Быстрые ссылки на ключевые файлы.
4. Архитектурный обзор и граф зависимостей (Mermaid).
5. Структуру проекта в виде дерева.
6. Исходный код выбранных файлов.
7. Итоговую статистику.

## Лицензия

Проект распространяется под лицензией Mozilla Public License 2.0. Подробности в файле [LICENSE](LICENSE).
